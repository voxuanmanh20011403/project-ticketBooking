...
function Sidenav(props, { color, brand, brandName, routes, ...rest }) {
  ...
  return (
    ...
    >
      ...
      <List style={{ display: "inline-grid" }}>
        ...
        <Button style={{paddingLeft: '50%', marginBottom:'5%'}}  onClick={() => onClickTaskValue(5)}>Quản lý vé xe & thanh toán</Button>
